	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form" style="" action="moteler/rooms/add" method="POST">
				...
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Vui lòng điền số ký điện">
					<span class="label-input100">Số ký điện *</span>
					<input class="input100" type="number" value="0" name="no_elec" id="no_elec" placeholder="Số ký điện" onchange="checkNo()">
				</div>

				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Vui lòng điền số ký nước">
					<span class="label-input100">Số ký nước *</span>
					<input class="input100" type="number" value="0" name="no_water" id="no_water" placeholder="Số ký nước" onchange="checkNo()">
				</div>
