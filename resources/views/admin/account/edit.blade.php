...
<div class="row">
	<div class="container-contact100">
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form" action="admin/account/edit/{{ $acc->id }}" method="POST">
				<input type="hidden" name="_token" value="{{ csrf_token() }}">
				<span class="contact100-form-title">
					Sửa Thông Tin Tài Khoản <br>
					Xin Chào <i>{{ $acc->moteler->frist_name.' '.$acc->moteler->last_name }}</i>
					<input type="text" hidden="hidden" readonly="readonly" value="{{ $acc->moteler->id }}" name="id_mler">
				</span>

				<div class="wrap-input100  validate-input rs1-wrap-input100  bg1" >
					<span class="label-input100">Họ </span>
					<input class="input100"  value="{{ $acc->moteler->frist_name }}" type="text" name="frist_name" placeholder="Vui lòng điền Họ của bạn...">
				</div>
				<div class="wrap-input100  validate-input rs1-wrap-input100  bg1">
					<span class="label-input100">Họ </span>
					<input class="input100"  value="{{ $acc->moteler->last_name }}" type="text" name="last_name" placeholder="Vui lòng điền Tên của bạn...">
				</div>

				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100">
					<span class="label-input100">Điện thoại</span>
					<input class="input100"  value="{{ $acc->moteler->phone }}" type="text" name="phone" placeholder="Điện thoại">
				</div>

				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100">
					<span class="label-input100">Hộp thư</span>
					<input class="input100"  value="{{ $acc->moteler->email }}" type="text" name="email" placeholder="Hộp thư">
				</div>
					
				<div class="wrap-input100 bg1">
					<span class="label-input100">Địa chỉ</span>
					<input class="input100" type="text" value="{{ $acc->moteler->address }}" name="address" placeholder="Địa chỉ ">
				</div>						
