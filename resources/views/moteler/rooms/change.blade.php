    ...
    <div class="card-body">
        ...
        @endif
            <div class="table-responsive">
                <form class="contact100-form validate-form" action="moteler/rooms/payRoom" method="POST">
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tr>
                            <td>Đổi phòng</td>
                            <td colspan="2">
                                <select name="name" id="name_room" class="input100" class="validate-input" onchange="set()" style="border-radius:5px; width:90%">
...
<script>
    function set() {
        var id = document.getElementById("name_room").value;
        var data_room = {!! $rooms !!};
...
<style >
    tbody tr:nth-child(1) td:nth-child(3) div input, tr:nth-child(1) td:nth-child(5) div input{
        text-align: center;
        width: 100%;
    }
    ...
    tbody tr:nth-child(1) td:nth-child(6) div {
        width: 100px;
    }
    tbody tr:nth-child(1) td:nth-child(7) div {
        text-align: right;
        width: 100px;
    }
    tbody tr:nth-child(1) td:nth-child(7) div input{
        color: red;
        font-weight: bold;
        text-align: right;
        width: 100%;
